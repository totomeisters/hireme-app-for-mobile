...
-- Database: `hireme`
--
CREATE DATABASE IF NOT EXISTS `hireme` DEFAULT CHARACTER
SET
...
CREATE TABLE
  IF NOT EXISTS `companies` (
    ...
    `UserID` int NOT NULL,
    `CompanyName` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `CompanyDescription` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `LegalDocuments` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'redundant, will remove later',
      `CompanyAddress` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `VerificationStatus` enum ('Verified', 'Pending', 'Rejected') CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
...
CREATE TABLE
  IF NOT EXISTS `companyapplication` (
    `CompanyApplicationID` int NOT NULL AUTO_INCREMENT,
    `CompanyID` int NOT NULL,
    `DocumentName` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `DocumentFilePath` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `VerificationStatus` enum ('Pending', 'Verified', 'Rejected') CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
      `ReasonForRejection` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE
  IF NOT EXISTS `companydocuments` (
...
CREATE TABLE
  IF NOT EXISTS `interviews` (
    ...
    `Status` enum ('Pending', 'No show', 'Done', 'Cancelled') CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
...
CREATE TABLE
  IF NOT EXISTS `jobs` (
    ...
    `CompanyID` int NOT NULL,
    `JobTitle` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `JobDescription` text CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `JobType` enum ('Full-Time', 'Part-Time', 'Contract', 'Intern') CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `SalaryMin` decimal(10, 2) NOT NULL,
      `SalaryMax` decimal(10, 2) NOT NULL,
      `WorkHours` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `JobLocation` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
      `JobLocationType` enum ('WFH', 'On Site') CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
    ...
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `JobIndustry` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `OtherIndustry` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
      PRIMARY KEY (`JobID`),
      KEY `CompanyID` (`CompanyID`)
...
CREATE TABLE
  IF NOT EXISTS `jobseekerapplication` (
    `JobSeekerApplicationID` int NOT NULL AUTO_INCREMENT,
    `JobID` int DEFAULT NULL,
    `UserID` int DEFAULT NULL,
    `ResumeFilePath` varchar(255) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `ApplicationDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
      `Status` enum ('Pending', 'Rejected', 'Verified') CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE
  IF NOT EXISTS `jobseekers` (
    `JobSeekerID` int NOT NULL AUTO_INCREMENT,
    `UserID` int NOT NULL,
    `FirstName` varchar(50) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
    ...
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
      `ContactNumber` varchar(11) CHARACTER
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `users` (
    ...
    SET
      utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'User',
...
--
ALTER TABLE `companies` ADD CONSTRAINT `companies_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `companyapplication`
--
ALTER TABLE `companyapplication` ADD CONSTRAINT `companyapplication_ibfk_1` FOREIGN KEY (`CompanyID`) REFERENCES `companies` (`CompanyID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `jobs`
--
ALTER TABLE `jobs` ADD CONSTRAINT `jobs_ibfk_1` FOREIGN KEY (`CompanyID`) REFERENCES `companies` (`CompanyID`) ON DELETE CASCADE ON UPDATE CASCADE;
